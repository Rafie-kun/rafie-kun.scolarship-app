...
export const WORLD_COUNTRIES = [
  ...
  'Fiji', 'Finland', 'Georgia', 'Ghana', 'Greece', 'Guatemala', 'Haiti', 
  'Honduras', 'Hong Kong', 'Hungary', 'Iceland', 'Indonesia', 'Iran', 'Iraq', 
  ...
  'Nepal', 'Nicaragua', 'Nigeria', 'North Macedonia', 'Norway', 'Oman', 
  'Panama', 'Papua New Guinea', 'Paraguay', 'Peru', 'Philippines', 'Poland', 
  'Portugal', 'Qatar', 'Romania', 'Rwanda', 'Saudi Arabia', 'Senegal', 
  'Serbia', 'Sierra Leone', 'Slovakia', 'Slovenia', 'Somalia', 'South Korea', 
  'Spain', 'Sri Lanka', 'Sudan', 'Sweden', 'Syria', 'Taiwan', 'Tajikistan', 
  'Tanzania', 'Thailand', 'Togo', 'Trinidad and Tobago', 'Tunisia', 'Turkey', 
  'Turkmenistan', 'Uganda', 'Ukraine', 'United Arab Emirates', 'Uruguay', 
  'Uzbekistan', 'Venezuela', 'Vietnam', 'Yemen', 'Zambia', 'Zimbabwe', 'Worldwide'
];

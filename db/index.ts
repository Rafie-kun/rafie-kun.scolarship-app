...
function deserializeProfile(row: any): Profile | null {
  ...
  return {
    ...
    onboardingCompleted: row.hasCompletedOnboarding === 1 || row.hasCompletedOnboarding === '1' || row.hasCompletedOnboarding === true || row.hasCompletedOnboarding === 'true',
...
export function saveProfile(username: string, updated: Partial<Profile>): void {
  ...
  stmt.run(
    ...
    merged.hasCompletedOnboarding || merged.onboardingCompleted ? 1 : 0,
  ...
  const usersToSeed = [
    {
      ...
      profile: {
        ...
        ieltsScore: "7.5",
        greScore: "318",
        leadershipExperience: ["Student Computing Club Treasurer", "Open Source Community Advocate"],
        ...
        highSchoolName: "Riverside Secondary School",
        collegeName: "Riverside Community College",
